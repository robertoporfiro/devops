...
variable "path_role_admins" {
  type = "string"
  default = "/home/campos/projects/analytics-mpms/operacao/cloud/azure_storage_account/role_admins.json"
}

variable "path_role_readers" {
  type = "string"
  default = "/home/campos/projects/analytics-mpms/operacao/cloud/azure_storage_account/role_readers.json"
}

variable "path_role_update_mpms" {
  type = "string"
  default = "/home/campos/projects/analytics-mpms/operacao/cloud/azure_storage_account/update_mpms.json"
}
